...
if(isset($_POST['submit'])){
    ...
    if ($result->num_rows > 0) {
        header('location:signin_values_insert_to_sessions.php?username='.$username.'&email='.$email.'&password='.$password.'');
      } else {
        $accNotExist = 'Credentials does not exist';
      }
}
...
<?PHP include 'header.php'; ?>
      ...
      <section class="signup container">
        <div class="text-center h1 my-5">SIGN IN FORM</div>
  ...
  <div class="error text-center text-danger"><?php echo $accNotExist ?></div>
